...
from test_helpers import (
    get_loki_labels, get_prometheus_labels, verify_monitoring_labels
)

@pytest.mark.order(9)
def test_monitoring_labels():
    print("\n=== Step 8: Testing Monitoring Labels ===")

    loki_labels = get_loki_labels()
    prometheus_labels = get_prometheus_labels()
    verify_monitoring_labels(loki_labels, prometheus_labels)


@pytest.mark.order(10)
def test_monitoring_services_health():
    print("\n=== Step 9: Testing Monitoring Services Health ===")
